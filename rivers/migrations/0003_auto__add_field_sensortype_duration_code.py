...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rivers_sensortype', 'duration_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SensorType.duration_code'
        db.delete_column('rivers_sensortype', 'duration_code')
