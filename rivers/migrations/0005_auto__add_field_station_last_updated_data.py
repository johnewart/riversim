...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Station.last_updated_data'
        db.add_column('rivers_station', 'last_updated_data', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Station.last_updated_data'
        db.delete_column('rivers_station', 'last_updated_data')
    ...
    models = {
        ...
        'rivers.measurement': {
            ...
            'time_window': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rivers.TimeWindow']", 'null': 'True', 'blank': 'True'}),
