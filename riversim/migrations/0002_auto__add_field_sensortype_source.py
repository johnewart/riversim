...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('riversim_sensortype', 'source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.DataSource'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SensorType.source'
        db.delete_column('riversim_sensortype', 'source_id')
