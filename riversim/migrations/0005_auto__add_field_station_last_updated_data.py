...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('riversim_station', 'last_updated_data', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Station.last_updated_data'
        db.delete_column('riversim_station', 'last_updated_data')
