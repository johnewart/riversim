...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Simulation.name'
        db.alter_column('riversim_simulation', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Simulation.name'
        raise RuntimeError("Cannot reverse this migration. 'Simulation.name' and its values cannot be restored.")
