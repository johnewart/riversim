...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimulationModel'
        db.create_table('riversim_simulationmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('riversim', ['SimulationModel'])

        # Adding model 'ModelParameter'
        db.create_table('riversim_modelparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.SimulationModel'])),
        ))
        db.send_create_signal('riversim', ['ModelParameter'])

        # Adding model 'RunParameter'
        db.create_table('riversim_runparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.ModelParameter'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('run', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.Run'])),
        ))
        db.send_create_signal('riversim', ['RunParameter'])

        # Adding model 'Run'
        db.create_table('riversim_run', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.Simulation'])),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('results', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('riversim', ['Run'])

        # Adding field 'Simulation.model'
        db.add_column('riversim_simulation', 'model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riversim.SimulationModel'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SimulationModel'
        db.delete_table('riversim_simulationmodel')

        # Deleting model 'ModelParameter'
        db.delete_table('riversim_modelparameter')

        # Deleting model 'RunParameter'
        db.delete_table('riversim_runparameter')

        # Deleting model 'Run'
        db.delete_table('riversim_run')

        # Deleting field 'Simulation.model'
        db.delete_column('riversim_simulation', 'model_id')
