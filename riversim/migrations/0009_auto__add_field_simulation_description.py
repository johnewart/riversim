...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.description'
        db.add_column('riversim_simulation', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.description'
        db.delete_column('riversim_simulation', 'description')
