...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'OrthoTile.desc_field' to match new field type.
        db.rename_column('riversim_orthotile', 'desc_field', 'desc_')
        # Changing field 'OrthoTile.desc_field'
        db.alter_column('riversim_orthotile', 'desc_', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, db_column='desc_'))

        # Renaming column for 'OrthoTile.dwr_tiles_field' to match new field type.
        db.rename_column('riversim_orthotile', 'dwr_tiles_field', 'dwr_tiles_')
        # Changing field 'OrthoTile.dwr_tiles_field'
        db.alter_column('riversim_orthotile', 'dwr_tiles_', self.gf('django.db.models.fields.FloatField')(null=True, db_column='dwr_tiles_'))

        # Renaming column for 'OrthoTile.oid_field' to match new field type.
        db.rename_column('riversim_orthotile', 'oid_field', 'oid_')
        # Changing field 'OrthoTile.oid_field'
        db.alter_column('riversim_orthotile', 'oid_', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='oid_'))

        # Renaming column for 'OrthoTile.poly_field' to match new field type.
        db.rename_column('riversim_orthotile', 'poly_field', 'poly_')
        # Changing field 'OrthoTile.poly_field'
        db.alter_column('riversim_orthotile', 'poly_', self.gf('django.db.models.fields.FloatField')(null=True, db_column='poly_'))

        # Renaming column for 'OrthoTile.subclass_field' to match new field type.
        db.rename_column('riversim_orthotile', 'subclass_field', 'subclass_')
        # Changing field 'OrthoTile.subclass_field'
        db.alter_column('riversim_orthotile', 'subclass_', self.gf('django.db.models.fields.FloatField')(null=True, db_column='subclass_'))

        # Adding field 'Simulation.bbox'
        db.add_column('riversim_simulation', 'bbox', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'OrthoTile.desc_field'
        raise RuntimeError("Cannot reverse this migration. 'OrthoTile.desc_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrthoTile.dwr_tiles_field'
        raise RuntimeError("Cannot reverse this migration. 'OrthoTile.dwr_tiles_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrthoTile.oid_field'
        raise RuntimeError("Cannot reverse this migration. 'OrthoTile.oid_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrthoTile.poly_field'
        raise RuntimeError("Cannot reverse this migration. 'OrthoTile.poly_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OrthoTile.subclass_field'
        raise RuntimeError("Cannot reverse this migration. 'OrthoTile.subclass_field' and its values cannot be restored.")

        # Deleting field 'Simulation.bbox'
        db.delete_column('riversim_simulation', 'bbox')
