...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.region'
        db.add_column('riversim_simulation', 'region', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.region'
        db.delete_column('riversim_simulation', 'region')
