...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.start_point'
        db.add_column('riversim_simulation', 'start_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.end_point'
        db.add_column('riversim_simulation', 'end_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.start_point'
        db.delete_column('riversim_simulation', 'start_point')

        # Deleting field 'Simulation.end_point'
        db.delete_column('riversim_simulation', 'end_point')
