...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrthoTile.geom'
        db.alter_column('riversim_orthotile', 'the_geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=50000, db_column='the_geom'))

        # Adding field 'Simulation.start_elevation'
        db.add_column('riversim_simulation', 'start_elevation', self.gf('django.db.models.fields.FloatField')(default=-1.0), keep_default=False)

        # Adding field 'Simulation.end_elevation'
        db.add_column('riversim_simulation', 'end_elevation', self.gf('django.db.models.fields.FloatField')(default=-1.0), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'OrthoTile.geom'
        db.alter_column('riversim_orthotile', 'the_geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=50000, db_column='the_geom'))

        # Deleting field 'Simulation.start_elevation'
        db.delete_column('riversim_simulation', 'start_elevation')

        # Deleting field 'Simulation.end_elevation'
        db.delete_column('riversim_simulation', 'end_elevation')
