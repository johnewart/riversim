...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.channel_width_job_complete'
        db.add_column('riversim_simulation', 'channel_width_job_complete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Simulation.channel_width_job_handle'
        db.add_column('riversim_simulation', 'channel_width_job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.channel_width_job_complete'
        db.delete_column('riversim_simulation', 'channel_width_job_complete')

        # Deleting field 'Simulation.channel_width_job_handle'
        db.delete_column('riversim_simulation', 'channel_width_job_handle')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 17, 12, 21, 365651)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 17, 12, 21, 365516)'}),
