...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.channel_width_x_origin'
        db.add_column('riversim_simulation', 'channel_width_x_origin', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.channel_width_y_origin'
        db.add_column('riversim_simulation', 'channel_width_y_origin', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.aerialmap_width'
        db.add_column('riversim_simulation', 'aerialmap_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.aerialmap_height'
        db.add_column('riversim_simulation', 'aerialmap_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.channel_width_x_origin'
        db.delete_column('riversim_simulation', 'channel_width_x_origin')

        # Deleting field 'Simulation.channel_width_y_origin'
        db.delete_column('riversim_simulation', 'channel_width_y_origin')

        # Deleting field 'Simulation.aerialmap_width'
        db.delete_column('riversim_simulation', 'aerialmap_width')

        # Deleting field 'Simulation.aerialmap_height'
        db.delete_column('riversim_simulation', 'aerialmap_height')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 17, 13, 6, 52, 19268)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 17, 13, 6, 52, 19132)'}),
