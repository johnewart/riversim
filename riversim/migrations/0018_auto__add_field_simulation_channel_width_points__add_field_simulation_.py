...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Simulation.channel_width_points'
        db.add_column('riversim_simulation', 'channel_width_points', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding field 'Simulation.channel_width_natural_width'
        db.add_column('riversim_simulation', 'channel_width_natural_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.channel_width_natural_height'
        db.add_column('riversim_simulation', 'channel_width_natural_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Simulation.channel_width_points'
        db.delete_column('riversim_simulation', 'channel_width_points')

        # Deleting field 'Simulation.channel_width_natural_width'
        db.delete_column('riversim_simulation', 'channel_width_natural_width')

        # Deleting field 'Simulation.channel_width_natural_height'
        db.delete_column('riversim_simulation', 'channel_width_natural_height')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 8, 22, 28, 15, 283939)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 8, 22, 28, 15, 283808)'}),
