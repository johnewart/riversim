...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AerialMap'
        db.create_table('riversim_aerialmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['riversim.Simulation'], unique=True)),
            ('job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('job_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('riversim', ['AerialMap'])

        # Adding model 'ElevationMap'
        db.create_table('riversim_elevationmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['riversim.Simulation'], unique=True)),
            ('job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('job_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('riversim', ['ElevationMap'])

        # Adding model 'ChannelWidthMap'
        db.create_table('riversim_channelwidthmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['riversim.Simulation'], unique=True)),
            ('job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('job_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('riversim', ['ChannelWidthMap'])

        # Adding model 'ChannelMap'
        db.create_table('riversim_channelmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['riversim.Simulation'], unique=True)),
            ('job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('job_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('riversim', ['ChannelMap'])

        # Adding field 'Simulation.elevation_map_job_handle'
        db.add_column('riversim_simulation', 'elevation_map_job_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Simulation.elevation_map_job_complete'
        db.add_column('riversim_simulation', 'elevation_map_job_complete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AerialMap'
        db.delete_table('riversim_aerialmap')

        # Deleting model 'ElevationMap'
        db.delete_table('riversim_elevationmap')

        # Deleting model 'ChannelWidthMap'
        db.delete_table('riversim_channelwidthmap')

        # Deleting model 'ChannelMap'
        db.delete_table('riversim_channelmap')

        # Deleting field 'Simulation.elevation_map_job_handle'
        db.delete_column('riversim_simulation', 'elevation_map_job_handle')

        # Deleting field 'Simulation.elevation_map_job_complete'
        db.delete_column('riversim_simulation', 'elevation_map_job_complete')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 9, 21, 30, 32, 754826)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 9, 21, 30, 32, 754698)'}),
        ...
        'riversim.aerialmap': {
            ...
            'simulation': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['riversim.Simulation']", 'unique': 'True'})
        },
