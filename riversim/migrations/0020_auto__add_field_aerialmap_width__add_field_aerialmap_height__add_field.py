...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AerialMap.width'
        db.add_column('riversim_aerialmap', 'width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AerialMap.height'
        db.add_column('riversim_aerialmap', 'height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ChannelWidthMap.image_natural_width'
        db.add_column('riversim_channelwidthmap', 'image_natural_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ChannelWidthMap.image_natural_height'
        db.add_column('riversim_channelwidthmap', 'image_natural_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ChannelWidthMap.channel_width_points'
        db.add_column('riversim_channelwidthmap', 'channel_width_points', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AerialMap.width'
        db.delete_column('riversim_aerialmap', 'width')

        # Deleting field 'AerialMap.height'
        db.delete_column('riversim_aerialmap', 'height')

        # Deleting field 'ChannelWidthMap.image_natural_width'
        db.delete_column('riversim_channelwidthmap', 'image_natural_width')

        # Deleting field 'ChannelWidthMap.image_natural_height'
        db.delete_column('riversim_channelwidthmap', 'image_natural_height')

        # Deleting field 'ChannelWidthMap.channel_width_points'
        db.delete_column('riversim_channelwidthmap', 'channel_width_points')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 9, 22, 24, 28, 212804)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 9, 22, 24, 28, 212687)'}),
