...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.name'
        db.alter_column(u'riversim_lidartile', 'name', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.name'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.name' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 51, 15, 421242)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 51, 15, 420779)'}),
