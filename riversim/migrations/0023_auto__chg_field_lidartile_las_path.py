...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.las_path'
        db.alter_column(u'riversim_lidartile', 'las_path', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.las_path'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.las_path' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 54, 58, 722521)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 54, 58, 722050)'}),
