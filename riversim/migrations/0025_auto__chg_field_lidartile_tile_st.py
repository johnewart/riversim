...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.tile_st'
        db.alter_column(u'riversim_lidartile', 'tile_st', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.tile_st'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.tile_st' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 56, 45, 740399)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 56, 45, 739945)'}),
