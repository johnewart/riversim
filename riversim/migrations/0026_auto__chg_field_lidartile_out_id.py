...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.out_id'
        db.alter_column(u'riversim_lidartile', 'out_id', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.out_id'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.out_id' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 57, 17, 706864)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 57, 17, 706374)'}),
