...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.lastaffine'
        db.alter_column(u'riversim_lidartile', 'lastaffine', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'LidarTile.affinepara'
        db.alter_column(u'riversim_lidartile', 'affinepara', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'LidarTile.enttypdesc'
        db.alter_column(u'riversim_lidartile', 'enttypdesc', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.guid'
        db.alter_column(u'riversim_lidartile', 'guid', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.lyrname'
        db.alter_column(u'riversim_lidartile', 'lyrname', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.areaunit'
        db.alter_column(u'riversim_lidartile', 'areaunit', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.entitytype'
        db.alter_column(u'riversim_lidartile', 'entitytype', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.to'
        db.alter_column(u'riversim_lidartile', 'to', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Changing field 'LidarTile.direction'
        db.alter_column(u'riversim_lidartile', 'direction', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'LidarTile.desc_field'
        db.alter_column(u'riversim_lidartile', 'desc_', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, db_column='desc_'))

        # Changing field 'LidarTile.lastdirect'
        db.alter_column(u'riversim_lidartile', 'lastdirect', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'LidarTile.desc1'
        db.alter_column(u'riversim_lidartile', 'desc1', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'LidarTile.del_date'
        db.alter_column(u'riversim_lidartile', 'del_date', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'LidarTile.lyrdesc'
        db.alter_column(u'riversim_lidartile', 'lyrdesc', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.lastaffine'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.lastaffine' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.affinepara'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.affinepara' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.enttypdesc'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.enttypdesc' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.guid'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.guid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.lyrname'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.lyrname' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.areaunit'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.areaunit' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.entitytype'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.entitytype' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.to'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.to' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.direction'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.direction' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.desc_field'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.desc_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.lastdirect'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.lastdirect' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.desc1'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.desc1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.del_date'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.del_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.lyrdesc'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.lyrdesc' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 58, 11, 329245)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 21, 58, 11, 328782)'}),
