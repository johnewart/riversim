...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.centroidy'
        db.alter_column(u'riversim_lidartile', 'centroidy', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'LidarTile.centroidx'
        db.alter_column(u'riversim_lidartile', 'centroidx', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'LidarTile.centroidz'
        db.alter_column(u'riversim_lidartile', 'centroidz', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'LidarTile.numverts'
        db.alter_column(u'riversim_lidartile', 'numverts', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'LidarTile.entarea'
        db.alter_column(u'riversim_lidartile', 'entarea', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.centroidy'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.centroidy' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.centroidx'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.centroidx' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.centroidz'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.centroidz' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.numverts'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.numverts' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.entarea'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.entarea' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 1, 4, 462400)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 1, 4, 461813)'}),
