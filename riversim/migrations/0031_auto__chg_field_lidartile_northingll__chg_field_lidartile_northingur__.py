...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LidarTile.northingll'
        db.alter_column(u'riversim_lidartile', 'northingll', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LidarTile.northingur'
        db.alter_column(u'riversim_lidartile', 'northingur', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LidarTile.northindex'
        db.alter_column(u'riversim_lidartile', 'northindex', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LidarTile.eastindex'
        db.alter_column(u'riversim_lidartile', 'eastindex', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LidarTile.eastingur'
        db.alter_column(u'riversim_lidartile', 'eastingur', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LidarTile.eastingll'
        db.alter_column(u'riversim_lidartile', 'eastingll', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LidarTile.northingll'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.northingll' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.northingur'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.northingur' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.northindex'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.northindex' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.eastindex'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.eastindex' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.eastingur'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.eastingur' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LidarTile.eastingll'
        raise RuntimeError("Cannot reverse this migration. 'LidarTile.eastingll' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 3, 6, 501709)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 3, 6, 501258)'}),
