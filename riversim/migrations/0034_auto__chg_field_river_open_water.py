...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'River.open_water'
        db.alter_column(u'riversim_river', 'open_water', self.gf('django.db.models.fields.CharField')(max_length=41, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'River.open_water'
        raise RuntimeError("Cannot reverse this migration. 'River.open_water' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 8, 24, 167495)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 2, 22, 8, 24, 167036)'}),
