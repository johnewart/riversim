...
def new(request):
    ...
    return render_to_response('riversim/simulations/new.html', params)

def list(request):
    return render_to_response('riversim/simulations/list.html')
...
def show(request, simulation_id):
    ...
    return render_to_response('riversim/simulations/show.html', params)